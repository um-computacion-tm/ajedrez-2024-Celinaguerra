...
- pawn promotion to queen in board
...
- end_game method in chess.py
- verification of is_king_alive in chess.py
- testing

## [0.1.27] - 2024-10-02
### Added

- is_king_alive method in board.py and testing

## [0.1.26] - 2024-10-01
### Added

- method in piece.py that verifies that a piece is inside the board and that verifies the color of other pieces

### Changed

- rook.py to avoid similar code with bishop.py

## [0.1.25] - 2024-09-30
### Changed

- modified possible_diagonal_possitions to avoid repetition with possible_orthogonal_positions
